...
@section('content')
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body register-card-body">
          ...
          <form action="{{ url('/register')}}" onsubmit="return myfunc();" method="post">
            @csrf
            <div class="input-group mb-1">
              <div class="form-floating">
                ...
                <div class="invalid-feedback" id="invalid-name">
                  <b><u>กรุณากรอกชื่อ ผู้ใช้งาน</u></b>
                </div>
              </div>
            ...
            <div class="input-group mb-1">
              <div class="form-floating">
                ...
                <div class="invalid-feedback" id="invalid-email">
                  <b><u>กรุณากรอก email ผู้ใช้งาน</u></b>
                </div>
              </div>
            ...
            <div class="input-group mb-1">
              <div class="form-floating">
                ...
                <div class="invalid-feedback" id="invalid-pass">
                  <b><u>กรุณากรอก password ผู้ใช้งาน</u></b>
                </div>
              </div>
